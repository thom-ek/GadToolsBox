...
ULONG PrefsWTags[]=
{
	WA_CenterX, TRUE, WA_CenterY, TRUE, WA_Width, 281, WA_Height, 139, WA_Title, (ULONG) MSG_Prefs_WND, WA_IDCMP, IDCMP_CLOSEWINDOW|IDCMP_GADGETDOWN|IDCMP_GADGETUP|BUTTONIDCMP|CHECKBOXIDCMP|CYCLEIDCMP, WA_Flags, WFLG_DRAGBAR|WFLG_DEPTHGADGET|WFLG_SIMPLE_REFRESH|WFLG_ACTIVATE|WFLG_NEWLOOKMENUS, WA_RMBTrap, TRUE, WA_FontAdaptive, TRUE, TAG_DONE
};

/* Prefs Gadget structures */
UBYTE *LABELS_LANGUAGE[]=
{
	(UBYTE *)MSG_LANGUAGE_L0_GAD,
	(UBYTE *)MSG_LANGUAGE_L1_GAD,
	(UBYTE *)MSG_LANGUAGE_L2_GAD,
	NULL
};
...
ULONG PrefsGTags[]=
{
	...
	CYCLE_KIND, PLACETEXT_LEFT, GTCY_Active, 0, GTCY_Labels, (ULONG) &LABELS_LANGUAGE, GA_Text, (ULONG) MSG_LANGUAGE_GAD, GA_Left, 80, GA_Top, 4, GA_Width, 185, GA_Height, 19, GA_UserData, (ULONG) FN_LANGUAGE_Clicked, TAG_DONE,
	CHECKBOX_KIND, PLACETEXT_LEFT, GTCB_Scaled, TRUE, GA_Text, (ULONG) MSG_CONVUNDERSCORES_GAD, GA_Left, 192, GA_Top, 28, GA_Width, 25, GA_Height, 17, GA_UserData, (ULONG) FN_CONVUNDERSCORES_Clicked, TAG_DONE
};
...
UWORD InitApplication(STRPTR language)
{
	...
	Catalog=OpenCatalog(Locale,"win32resource.generator.catalog",
	...
	while(m=GT_GetIMsg(PrefsWnd->UserPort))
	{
		...
		switch(PrefsMsg.Class)
		{
			...
			case IDCMP_GADGETDOWN:
				func=(int (*)(void))(( struct Gadget * )PrefsMsg.IAddress )->UserData;
				running=func();
				if(running > 1) return running;
				break;
		}
