...
void GADGET_GenerateTags(BPTR handle,piObject *go)
{
	...
	switch(ng->ng_PlugInID)
	{
		case BUTTON_ID:
			...
			{
				case 0: FPuts(handle,"BUTTON_KIND, "); break;
				case 1:
				case 2: FPuts(handle,"TOOLIMAGE_KIND, "); break;
			}
